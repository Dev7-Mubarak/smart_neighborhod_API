...
namespace SmartNeighborhoodAPI.Controllers.V1
{
    ...
    public class BlockController : AppControllerBase
    {
        ...
        public async Task<IActionResult> ChangeManager(int id, [FromBody, SwaggerParameter("Manager change details", Required = true)] ChangeManagerDto blockManagerDto)
        {
