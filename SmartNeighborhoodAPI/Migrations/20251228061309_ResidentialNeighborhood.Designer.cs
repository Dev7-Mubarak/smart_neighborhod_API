...
namespace SmartNeighborhoodAPI.Migrations
{
    ...
    [Migration("20251228061309_ResidentialNeighborhood")]
    partial class ResidentialNeighborhood
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartNeighborhoodAPI.Entites.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1d6e6d59-96c4-4a28-a9a4-678c08103d41",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBLUSmWyvnp9FMo3HFx/k/O0OBtpZ73vc6Xjyn0mK+Bbc0TOkYYHF/BgpjCtBBL7ig==",
                            PersonId = 1,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "24395e7d-2078-4924-a630-c36a1d5a8c4b",
            ...
            modelBuilder.Entity("SmartNeighborhoodAPI.Entites.ResidentialNeighborhood", b =>
                {
                    ...
                    b.ToTable("ResidentialNeighborhood");
                });
            ...
            modelBuilder.Entity("SmartNeighborhoodAPI.Entites.ResidentialNeighborhood", b =>
                {
                    b.HasOne("SmartNeighborhoodAPI.Entites.AppUser", "NeighborhoodManager")
                        .WithMany()
                        .HasForeignKey("NeighborhoodManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
