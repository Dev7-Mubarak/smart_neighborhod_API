    ...
    public class IDCardApplicationConfiguration : IEntityTypeConfiguration<IDCardApplication>
    {
        public void Configure(EntityTypeBuilder<IDCardApplication> builder)
        {
            ...
            builder.HasData(
                ...
                new IDCardApplication { Id = 21, ResidentId = 1, ApplicationNumber = "IDC2001", Status = ApplicationStatus.Ready, Notes = null },
                new IDCardApplication { Id = 22, ResidentId = 2, ApplicationNumber = "IDC2002", Status = ApplicationStatus.InProgress },
